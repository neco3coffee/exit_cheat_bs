        ...
        if (variant === "circle") {
          return (
            <li
              ...
              className={cn(
                "flex flex-col shrink-0 items-center gap-4 rounded-md transition-colors max-w-[20%]!",
                className
              )}
            >
              <CircleStepIndicator
        ...
        return (
          <>
            <li
              date-component="stepper-step"
              className={cn([
                "group peer relative flex flex-col items-center gap-2",
                "data-[variant=vertical]:flex-row",
                "data-[label-orientation=vertical]:w-full",
                "data-[label-orientation=vertical]:flex-col",
                "data-[label-orientation=vertical]:justify-center",
                "max-w-[20%]! text-center",
              ])}
            ...
            >
              <Button
                ...
                className={`rounded-full text-white  ${dataState === "active" && step.id === "step-4" ? "bg-green-500" : dataState === "completed" ? "bg-green-500 hover:bg-green-400" : dataState === "active" ? "bg-blue-500 hover:bg-blue-400" : "bg-gray-300 hover:bg-gray-200"}`}
              ...
              >
                {/* {icon ?? stepIndex + 1} */}
                {
                  step.id === "step-4" && dataState === "active" ? (
                    <CircleCheck className="w-[30px]! h-[30px]!" />
                  ) : (
                    dataState === "completed"
                      ? <CircleCheck className="w-[30px]! h-[30px]!" />
                      : dataState === "active"
                        ? <CircleDot className="w-[30px]! h-[30px]!" />
